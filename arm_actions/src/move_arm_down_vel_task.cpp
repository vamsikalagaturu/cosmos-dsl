...
int main()
{
  ...
  auto move_arm_down_vel = [&]()
  {
    ...
    PIDController pid_move_arm_down_lin_vel_controller(30.0, 0.9, 0.0, 1);

    PIDController pid_move_arm_down_ang_vel_controller(10.0, 0.9, 0.0, 1);
    ...
    while (true)
    {
      ...
      std::vector<KDL::Frame> frames(n_segments - 1);

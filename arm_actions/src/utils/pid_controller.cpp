...
std::tuple<double, double, double> PIDController::calc_error(const std::array<double, 3>& p1, const std::array<double, 3>& p2)
{
    double dx = p2[0] - p1[0];
    double dy = p2[1] - p1[1];
    double dz = p2[2] - p1[2];
...
std::tuple<double, double, double> PIDController::computeControlSignal(const std::array<double, 3>& current_value,

...
void SolverUtils::populateAlphaUnitForces(const std::vector<double>& alpha_lin, const std::vector<double>& alpha_ang, KDL::Jacobian* alpha_unit_forces)
{
...
KDL::ChainHdSolver_Vereshchagin SolverUtils::initializeVereshchaginSolver(
    const KDL::Chain *robot_chain,
    const std::array<double, 6> constraint_weights,
    ...
    // linear unit forces
    std::vector<double> alpha_lin = {constraint_weights[0], constraint_weights[1], constraint_weights[2]};
    // angular unit forces
    std::vector<double> alpha_ang = {constraint_weights[3], constraint_weights[4], constraint_weights[5]};
...
std::tuple<std::array<double, 3>, std::array<double, 3>> SolverUtils::computeFK(KDL::Chain *robot_chain, KDL::JntArray& q)
{
    // create the solver
...
void SolverUtils::updateBetaEnergy(KDL::JntArray& beta_energy, const std::array<double, 6>& control_ae)
{
...
void SolverUtils::updateQandQd(KDL::JntArray& q, KDL::JntArray& qd, const KDL::JntArray& qdd, double dt)
{
